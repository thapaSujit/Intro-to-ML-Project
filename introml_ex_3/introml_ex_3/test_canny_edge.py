...
class TestCanny(unittest.TestCase):
    ...
    def setUp(self) -> None:
        self.img = cv2.imread('introml_ex_3\introml_ex_3\contrast.jpg', cv2.IMREAD_GRAYSCALE)
    ...
    def test_gauss(self):
        ...
        self.assertTrue(res.dtype == np.int, msg='cast filtered image back to int')
    ...
    def test_sobel(self):
        ...
        self.assertTrue(gx.dtype == np.int, msg='cast filtered image back to int')
    ...
    def test_gradient_direction(self):
        ...
        self.assertTrue(g.dtype == np.int, msg='cast filtered image back to int')
        self.assertTrue(t.dtype == np.float, msg='angles in radias should be floating point precision')
