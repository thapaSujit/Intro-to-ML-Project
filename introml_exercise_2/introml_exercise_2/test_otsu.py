...
class TestOtsu(unittest.TestCase):
    ...
    def setUp(self) -> None:
        assert os.path.exists('introml_exercise_2\introml_exercise_2\contrast.jpg')
        self.img = cv2.imread('introml_exercise_2\introml_exercise_2\contrast.jpg', cv2.IMREAD_GRAYSCALE)
